      ...
      <div class="row">
        ...
        <div class="col-md-3 sm-margin-bottom-40">
          ...
          <ul class="list-unstyled thumb-news">
            <li>
              <img class="radius-3x" src="${pageContext.request.contextPath}/resources/img/thumb/01.jpg" alt="">
            ...
            <li>
              <img class="radius-3x" src="${pageContext.request.contextPath}/resources/img/thumb/02.jpg" alt="">
              <div class="overflow-h">
