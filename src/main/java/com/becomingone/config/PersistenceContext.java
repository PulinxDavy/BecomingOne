 ...
 */
@Configuration
@EnableJpaRepositories(basePackages = {"com.becomingone.repository"})
@EnableTransactionManagement
public class PersistenceContext {

    private static final String PROPERTY_PACKAGE_TO_SCAN = "com.becomingone.model";
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        entityManagerFactoryBean.setPackagesToScan(PROPERTY_PACKAGE_TO_SCAN);
